...
{
    public partial class CompletedDetailsPage : ContentPage
    {
        ...
        public CompletedDetailsPage(DateTime datetime, string user_id, string tax_name)
        {
            InitializeComponent();

            JobDate.Text= datetime.ToLongDateString();
